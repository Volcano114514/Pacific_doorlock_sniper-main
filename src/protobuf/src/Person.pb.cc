...
const uint32_t TableStruct_Person_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Person, colcor_),
};
...
const char descriptor_table_protodef_Person_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014Person.proto\032\rAddress.proto\"m\n\006Person\022"
  "\n\n\002id\030\001 \001(\005\022\014\n\004name\030\002 \003(\014\022\013\n\003sex\030\003 \001(\014\022\013"
  "\n\003age\030\004 \001(\005\022\026\n\004addr\030\005 \001(\0132\010.Address\022\027\n\006c"
  "olcor\030\006 \001(\0162\007.Colcor*2\n\006Colcor\022\007\n\003Red\020\000\022"
...
const ::_pbi::DescriptorTable descriptor_table_Person_2eproto = {
    false, false, 200, descriptor_table_protodef_Person_2eproto,
    "Person.proto",
...
Person::Person(const Person& from)
  ...
  ::memcpy(&id_, &from.id_,
    static_cast<size_t>(reinterpret_cast<char*>(&colcor_) -
    reinterpret_cast<char*>(&id_)) + sizeof(colcor_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&colcor_) -
    reinterpret_cast<char*>(&addr_)) + sizeof(colcor_));
}
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          ...
          CHK_(ptr);
          _internal_set_colcor(static_cast<::Colcor>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Person::_InternalSerialize(
  ...
  // .Colcor colcor = 6;
  if (this->_internal_colcor() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      6, this->_internal_colcor(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Person)
  ...
  if (this->_internal_colcor() != 0) {
    total_size += 1 +
      ::_pbi::WireFormatLite::EnumSize(this->_internal_colcor());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Person)
  ...
  if (from._internal_colcor() != 0) {
    _internal_set_colcor(from._internal_colcor());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
