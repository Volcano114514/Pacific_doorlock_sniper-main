...
enum Colcor : int {
  ...
  Yellow = 6,
  Blue = 9,
  Colcor_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Colcor_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool Colcor_IsValid(int value);
constexpr Colcor Colcor_MIN = Red;
constexpr Colcor Colcor_MAX = Blue;
constexpr int Colcor_ARRAYSIZE = Colcor_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Colcor_descriptor();
template<typename T>
inline const std::string& Colcor_Name(T enum_t_value) {
  static_assert(::std::is_same<T, Colcor>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function Colcor_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    Colcor_descriptor(), enum_t_value);
}
inline bool Colcor_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Colcor* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<Colcor>(
    Colcor_descriptor(), name, value);
}
// ===================================================================
...
class Person final :
 ...
 public:
  ...
  void clear_colcor();
  ::Colcor colcor() const;
  void set_colcor(::Colcor value);
  private:
  ::Colcor _internal_colcor() const;
  void _internal_set_colcor(::Colcor value);
  public:
...
void Person::set_sex(ArgT0&& arg0, ArgT... args) {
 ...
 sex_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
// .Colcor colcor = 6;
inline void Person::clear_colcor() {
  colcor_ = 0;
}
inline ::Colcor Person::_internal_colcor() const {
  return static_cast< ::Colcor >(colcor_);
}
inline ::Colcor Person::colcor() const {
  // @@protoc_insertion_point(field_get:Person.colcor)
  return _internal_colcor();
}
inline void Person::_internal_set_colcor(::Colcor value) {
  
  colcor_ = value;
}
inline void Person::set_colcor(::Colcor value) {
  _internal_set_colcor(value);
  // @@protoc_insertion_point(field_set:Person.colcor)
}
...
template <> struct is_proto_enum< ::Colcor> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Colcor>() {
  return ::Colcor_descriptor();
}
